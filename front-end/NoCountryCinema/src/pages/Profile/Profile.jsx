  ...
  return (
      ...
      <Container>
        <Container  className="text-end"><Button style={{
          color:"whitesmoke"
        }} size='xs' variant='outline' onClick={handlerClick}>Cerrar Sesión</Button></Container>
            ...
            <Row className="ps-5 pe-5">
              ...
              <Card className="text-center bg-dark">
                ...
                <Card.Body>
                  ...
                  <Card.Text>
                    <i className="bi bi-calendar3 fs-5 pe-1"></i>Hoy, 11 de Abril,
                    2022
                  </Card.Text>
                  <Card.Text>
                  ...
                  <Card.Text>
                    <i className="bi bi-geo-alt fs-5 pe-1"></i>Ubicaciones: P-6, P-7
                  </Card.Text>
