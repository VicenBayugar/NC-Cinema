        ...
        <ModalBody>
          <Form>
            <Form.Group className="mb-3">
              ...
              <Form.Control type="text" name="title" value={movie.title} />
              ...
              <Form.Control type="text" name="origin" value={movie.origin} />
              <Form.Label>Género</Form.Label>
              <Form.Control type="text" name="genre" value={movie.genre} />
              ...
              <Form.Control type="text" name="actors" value={movie.actors} />
              <Form.Label>Calificacion </Form.Label>
              <Form.Control type="text" name="qualify" value={movie.qualify} />
